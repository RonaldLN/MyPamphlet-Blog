...
-   `css` 文件中的 `data-md-color-scheme=` 后的引号中的内容，就是可以/应该写在 `mkdocs.yml` 中 `scheme:` 后的*关键字*，
...
[提升审美色感 |“漫天云彩，治愈色彩”高级感治愈天空配色_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1sr4y1t7u6/?spm_id_from=333.788&vd_source=587a9a51322cceeb38c3807fd9626459)
